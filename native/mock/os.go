...
func (OS) App_AddMouseEventListener(win native.Handle, listener native.MouseEventListener) (remove func()) {
	type privateKey int
	...
	mockos.SetMessageDispatcher(func(msg *mockos.Msg, prev func(*mockos.Msg) any) any {
		...
		case mockos.MsgMouseLeftDown:
			callMouseEventListeners(msg.Window, evt.X, evt.Y, mouseEventListeners,
...
var lastMessageBoxParams MessageBoxParams

var nextMessageBoxReturn struct {
...
func (OS) MessageBox(parent native.Handle, title, message string, icon native.MessageBoxIcon, button native.MessageBoxButton) (ret native.MessageBoxReturn, err error) {
	...
	return nextMessageBoxReturn.ret, nextMessageBoxReturn.err
}

func (OS) Debug_LastMessageBoxParams() MessageBoxParams {
	return lastMessageBoxParams
}

func (OS) Debug_SetNextMessageBoxReturn(ret native.MessageBoxReturn, err error) {
	nextMessageBoxReturn.ret = ret
	nextMessageBoxReturn.err = err
}
