...
// WindowPos returns the position of the pointer event in the coordinate system of the native window's client area.
func (evt *PointerEvent) WindowPos() (pos goui.Point, err error) {
	x, y, err := native.Window_ClientCoordinatesConv(evt.nativeParent, evt.nativeWindow,
